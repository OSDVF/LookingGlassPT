...
{
	return getRotationMatrix() * glm::translate(glm::mat4(1), -_position);
}
...
void MouseCamera::handleMouseInput(bool mouseLocked, float deltaTime, SDL_MouseMotionEvent mouseState)
{
	...
	{
		relY = mouseState.y - _previousMouseState.y;
		relX = mouseState.x - _previousMouseState.x;
	}
